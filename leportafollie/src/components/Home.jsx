      ...
      <div className="content">
        ...
        <div className="projects list-section">
          ...
          <ul>
            ...
            <p>From <a href="https://www.behance.net/gallery/99482723/Localsumer-Business-Directory" target="_blank">ideation</a> to launch of the <a href="https://www.localsumer.com/">web app</a>.</p>
            Learn more about Localsumer in this <a href="https://www.youtube.com/watch?v=Tjxtfp9kzco">video</a>. 👈🏼
            <p><i> (psst... psst... before launching we made it to round two of <a href="https://masschallenge.org/programs-mexico">MassChallenge Mexico</a>, and we celebrate that! 🎉)</i></p>
            ...
            <p>Ideated, <a href="https://www.behance.net/gallery/100190355/Flekora-UXUI-Case-Study">created</a> and programmed <a href="https://weareflekora.com/#Services">Flekora's website</a>.👾</p>
            ...
            <p>See the <a href="https://drive.google.com/file/d/1WnxsNw5WEzZKmNrmvGL2C5YJhvhwf1GD/view?usp=sharing">design process</a> 🔁 and <a href="https://drive.google.com/file/d/1GCHbtdNG2Vdc5MCP9tqimNDzB2VZwgFE/view?usp=sharing">visual design</a>.🎨</p>
            <br></br>
          ...
          <ul>
            ...
            <p>
              Collaborated with <a href="https://startuplinks.world/">Startuplinks</a> to provide UX/UI feedback to high impact startups in
